...
const supabaseUrl = process.env.REACT_APP_SUPABASE_URL || 'https://kjnbfsgbvcaxuwqwbomu.supabase.co';
const supabaseAnonKey = process.env.REACT_APP_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImtqbmJmc2didmNheHV3cXdib211Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTczMzA2MDcsImV4cCI6MjA3MjkwNjYwN30.utdLMJP13dGdqpeBiHa99wQ5M6Q-_FSydoWP6GdVT1U';
const supabase = createClient(supabaseUrl, supabaseAnonKey);

// Stripe Configuration
const stripePublishableKey = process.env.REACT_APP_STRIPE_PUBLISHABLE_KEY || 'pk_test_...';
...
export default App;d">
        ...
        <div className="bg-white p-6 rounded-lg shadow-m